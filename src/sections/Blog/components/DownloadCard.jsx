...
const DownloadCard = () => {
  return (
    <motion.div
      className="flex w-full flex-col-reverse items-center justify-between gap-16 rounded-3xl border border-customBorderPrimary bg-customCardBackground px-8 py-12 text-start"
    ...
    >
      ...
      <div className="w-full space-y-16">
        ...
        >
          ...
          <h2 className="text-3xl font-bold text-customTextPrimary lg:text-4xl">
